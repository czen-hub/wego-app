    ...
    <div className="min-h-screen bg-background flex flex-col items-center justify-center px-6 py-12">
      <div className="w-full max-w-sm">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-foreground">WeGo</h1>
          <p className="text-sm text-muted-foreground mt-1">Rides that are fair for everyone</p>
        </div>

        {/* Card */}
        <div className="bg-card border border-border rounded-2xl p-6 space-y-5 shadow-sm">
          <h2 className="text-lg font-semibold text-foreground">
            {mode === "signin" ? "Sign in to your account" : mode === "signup" ? "Create your account" : "Reset password"}
          </h2>
        ...
        <p className="text-center text-[11px] text-muted-foreground mt-6 px-4">
          WeGo Cooperative — Rides that pay drivers fairly and charge riders less.
        </p>
      </div>
    </div>
  );
